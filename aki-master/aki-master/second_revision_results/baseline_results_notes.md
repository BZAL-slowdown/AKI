...
- Robustness check: repeated stratified 5-fold CV used each model's modal hyperparameters from the primary nested CV. The best mean repeated-CV AUC was Gradient boosting at 0.628 +/- 0.084 SD.
